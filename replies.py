...
REPLIES = {
    ...
    "как дела": ["как дела — хуёво всегда"],
    "пока": ["пока — соси бока"],
    "утро": ["утро — в жопе нутро"],
    "вечер": ["вечер — ебучий свечер"],
    "любовь": ["любовь — в пизду морковь"],
    "работа": ["работа — ебучая забота"],
    "учеба": ["учёба — ебала злоба"],
    "жиза": ["жиза — хуиза"],
    "деньги": ["деньги — в рот ебеньки"],
    "сон": ["сон — иди нахуй вон"],
    "еда": ["еда — хуйня всегда"],
    "водка": ["водка — залетай, красотка"],
    "пиво": ["пиво — залупа красиво"],
    "вино": ["вино — ебало в говно"],
}
